...
cd $GOPATH/src/github.com/libonomy/aphelion-staking/networks/remote/terraform
...
cd $GOPATH/src/github.com/libonomy/aphelion-staking/networks/remote/ansible

# create config dirs
aphelion testnet

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/libonomy/aphelion-staking/build/aphelion -e CONFIGDIR=$GOPATH/src/github.com/libonomy/aphelion-staking/networks/remote/ansible/mytestnet
...
old_ansible_file=$GOPATH/src/github.com/libonomy/aphelion-staking/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
