...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/evdatsion/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/evdatsion/tendermint/config/tendermint"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/evdatsion/tendermint/libs/bits"
