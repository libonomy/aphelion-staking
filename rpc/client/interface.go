...
to a libonomy node, as well as higher-level functionality.

The main implementation for production code is client.HTTP, which
connects via http to the jsonrpc interface of the libonomy node.
...
// string. see libonomy/types/events.go
