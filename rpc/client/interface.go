...
to a aphelion node, as well as higher-level functionality.

The main implementation for production code is client.HTTP, which
connects via http to the jsonrpc interface of the aphelion node.
...
// string. see aphelion/types/events.go
