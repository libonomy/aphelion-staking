...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/libonomy/aphelion-staking' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/aphelion
    ln -s /vagrant /home/vagrant/go/src/github.com/libonomy/aphelion-staking
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/libonomy/aphelion-staking && make get_tools'
  SHELL
end
