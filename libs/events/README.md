...
# events
`import "github.com/libonomy/aphelion-staking/libs/events"`
...
[event_cache.go](/src/github.com/libonomy/aphelion-staking/libs/events/event_cache.go) [events.go](/src/github.com/libonomy/aphelion-staking/libs/events/events.go) 
...
```
Generic event data can be typed and registered with aphelion/go-amino
