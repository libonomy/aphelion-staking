...
# ZIP one file as "libonomy" into a ZIP like libonomy_VERSION_OS_ARCH.zip
...
if __name__ == "__main__":
  ...
  parser.add_argument("--file", default="build/libonomy_{0}_{1}".format(os.environ.get('GOOS'),os.environ.get('GOARCH')), help="File to zip")
  ...
  file = zip_asset(args.file,args.destination,"libonomy",args.version,args.goos,args.goarch)
  print(file)
