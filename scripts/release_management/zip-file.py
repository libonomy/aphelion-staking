...
# ZIP one file as "aphelion" into a ZIP like aphelion_VERSION_OS_ARCH.zip
...
if __name__ == "__main__":
  ...
  parser.add_argument("--file", default="build/aphelion_{0}_{1}".format(os.environ.get('GOOS'),os.environ.get('GOARCH')), help="File to zip")
  ...
  file = zip_asset(args.file,args.destination,"aphelion",args.version,args.goos,args.goarch)
  print(file)
