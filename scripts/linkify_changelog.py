...
# " [\#number](https://github.com/libonomy/aphelion-staking/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://github.com/libonomy/aphelion-staking/issues/\1)", line.rstrip())
    print(line)