...
The community has provided a number of additional implementations, see the [Tendermint Ecosystem](https://github.com/evdatsion/awesome#ecosystem)
...
- [The main spec](https://github.com/evdatsion/spec/blob/master/spec/abci/abci.md)
