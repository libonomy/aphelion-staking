...
Thank you for considering making contributions to Tendermint and related repositories! Start by taking a look at the [coding repo](https://github.com/evdatsion/coding) for overall information on repository workflow and standards.
...
See the [open issues](https://github.com/evdatsion/aphelion-dpos-bft/issues) for things we need help with!
...
`$GOPATH/src/github.com/evdatsion/aphelion-dpos-bft`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/evdatsion/aphelion-dpos-bft`)
...
`GO111MODULE=on go get -u github.com/evdatsion/go-amino@master`.
...
- create a development branch either on github.com/evdatsion/aphelion-dpos-bft, or your fork (using `git remote add origin`)
