...
* The [`PublicKey` type](https://github.com/evdatsion/tendermint/blob/master/proto/tendermint/crypto/keys.proto#L13-L15)
...
* The `state` package now has a `Store` interface. All functions in
  [state/store.go](https://github.com/evdatsion/tendermint/blob/56911ee35298191c95ef1c7d3d5ec508237aaff4/state/store.go#L42-L42)
...
```sh
go install -mod=readonly -ldflags "-X github.com/evdatsion/tendermint/version.TMCoreSemVer=$(go list -m github.com/evdatsion/tendermint | sed  's/ /\@/g') -s -w " -trimpath ./cmd
```
...
See [\#63](https://github.com/evdatsion/spec/pull/63) for the complete spec
change.
...
[here](https://github.com/evdatsion/tendermint/pull/3668).
...
keys are called
[compositeKeys](https://github.com/evdatsion/tendermint/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md).
...
* [Merkle tree](https://github.com/evdatsion/spec/blob/master/spec/blockchain/encoding.md#merkle-trees)
* [ConsensusParams](https://github.com/evdatsion/spec/blob/master/spec/blockchain/state.md#consensusparams)

There was also a small change to field ordering in the vote struct. Any
implementations of an out-of-process validator (like a Key-Management Server)
will need to be updated. For specific details:

* [Vote](https://github.com/evdatsion/spec/blob/master/spec/consensus/signing.md#votes)
