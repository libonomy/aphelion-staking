...
const (
	...
	// https://github.com/evdatsion/tendermint/pull/3438
...
// dbStore wraps a db (github.com/evdatsion/tm-db)
type dbStore struct {
	db dbm.DB
}
...
// encoding not preserving ordering: https://github.com/evdatsion/tendermint/issues/4567
