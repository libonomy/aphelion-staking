...
(ABCI)](https://github.com/evdatsion/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/evdatsion/tendermint) (the
...
Types](https://github.com/evdatsion/tendermint/blob/master/abci/README.md#message-types).
