...
Tendermint uses the proto3 derivative [Amino](https://github.com/evdatsion/go-amino) for all data structures.
...
specification](https://github.com/evdatsion/go-amino#amino-encoding-for-go) for
more details.
...
spec](https://github.com/evdatsion/go-amino#computing-the-prefix-and-disambiguation-bytes).
...
Because Tendermint only uses a Simple Merkle Tree, application developers are expect to use their own Merkle tree in their applications. For example, the IAVL+ Tree - an immutable self-balancing binary tree for persisting application state is used by the [Cosmos SDK](https://github.com/evdatsion/cosmos-sdk/blob/ae77f0080a724b159233bd9b289b2e91c0de21b5/docs/interfaces/lite/specification.md)
...
[#1622](https://github.com/evdatsion/tendermint/issues/1622).
