...
repository](https://github.com/evdatsion/aphelion-dpos-bft).

The Tendermint remote signer test harness facilitates integration testing
between Tendermint and remote signers such as
[KMS](https://github.com/evdatsion/kms). Such remote signers allow for signing
...
[Tendermint](https://github.com/evdatsion/aphelion-dpos-bft).
...
you how to execute its tests against [KMS](https://github.com/evdatsion/kms).
...
See the [KMS repo](https://github.com/evdatsion/kms) for details on how to set
