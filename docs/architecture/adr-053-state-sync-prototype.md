...
State sync is now [merged](https://github.com/evdatsion/tendermint/pull/4705). Up-to-date ABCI documentation is [available](https://github.com/evdatsion/spec/pull/90), refer to it rather than this ADR for details.
