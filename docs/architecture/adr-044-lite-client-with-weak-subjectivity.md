...
[lite](https://github.com/evdatsion/aphelion-dpos-bft/tree/master/lite) package. This
...
rules](https://github.com/evdatsion/aphelion-dpos-bft/blob/master/docs/spec/blockchain/blockchain.md#validation)
to each block.
...
[here](https://github.com/evdatsion/aphelion-dpos-bft/blob/master/docs/spec/consensus/light-client.md).
