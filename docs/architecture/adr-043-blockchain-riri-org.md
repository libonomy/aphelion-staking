...
The following diagram illustrates the state of the [blockchain-reorg](https://github.com/evdatsion/tendermint/pull/35610) reactor which will be referred to as `v1`.
...
Diagram](https://github.com/evdatsion/tendermint/blob/f9e556481654a24aeb689bdadaf5eab3ccd66829/docs/architecture/img/blockchain-reactor-v2.png)
